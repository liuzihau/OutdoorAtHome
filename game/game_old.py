    ...
    if game_type == "game1":
        ...
        for g in tick:
            ...
            if random.random()>0.3:
                choice = random.sample([[(860,240),(240,150),'left_hand'],[(630,240),(240,150),'right_hand']],k=1)
                ok = Circle(start=choice[0][0],length=choice[0][1],time = g-0.05,position=choice[0][2]) #choice 取陣列[(860,240),(120,150),'left_hand']後取段               
                rand_list.append(ok)
                continue

            else:
                choice = random.sample([[(520,135),(300,600),'left_dodge'],[(705,135),(300,600),'right_dodge']],k=1)
                    # print(choise_list) 
